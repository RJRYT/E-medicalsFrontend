...
import illustration from "../Assets/img/pharmacy.jpg";
      ...
      <div>
        <section className="rjr_hero rjr_container rjr_flex rjr_section">
          ...
          <div className="rjr_hero-cap">
            <h1 className="rjr_h1">Your Reliable Pharmacy.</h1>
            <p className="rjr_p">
              Welcome to our pharmacy, your go-to destination for seamless
              medication management. We prioritize your health and convenience,
              offering efficient prescription services and personalized care.
              Trust us for a reliable and straightforward pharmacy experience
              tailored to you.{" "}
            </p>
