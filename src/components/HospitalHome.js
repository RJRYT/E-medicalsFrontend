...
import illustration from "../Assets/img/hospitalhome.jpg";
...
function HospitalHome() {
  return (
    <div>
      ...
      <h1 className='rjr_h1'>Elevating Hospital Excellence.</h1>
            <p className='rjr_p'>
            Experience healthcare at its finest with Hospital Excellence. We're committed to elevating standards and providing top-notch care. Your well-being is our priority, ensuring you receive the best in hospital services for a healthier tomorrow.
        </p>
